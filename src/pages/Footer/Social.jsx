...
export default function Social() {
  return (
    <ul className={classes.social}>
      ...
      <li className={classes.socialItem}>
        <Link
          to="https://mail.google.com/mail/u/0/#sent?compose=new"
          target="_blank"
        >
          <svg
            width="72px"
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              {" "}
              <title>email [#B03052]</title> <desc>Created with Sketch.</desc>{" "}
              <defs> </defs>{" "}
              <g
                id="Page-1"
                stroke="none"
      ...
      <li className={classes.socialItem}>
        <Link to="https://github.com/oponefrank44" target="_blank">
          <svg
            fill="#B03052"
            width="64px"
            height="64px"
      ...
      <li className={classes.socialItem}>
        <Link
          to="https://www.linkedin.com/in/frank-opone-a56688232/"
          target="_blank"
        >
          <svg
            width="64px"
