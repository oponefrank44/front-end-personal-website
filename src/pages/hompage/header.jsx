...
export default function Header() {
  ...
  return (
    <div className={classes["header-Main-container"]}>
      {/* floadting ball */}
      <div className={classes["header-Main--floating-ball-outer"]}></div>
      {/* heading and subheading */}
      <div className={classes["header-Main--heading-container"]}>
        <h1>Welcome</h1>

        <p className={classes["header-Main--heading-container--p"]}>
      ...
      <div className={classes["header-Main--profile-picture-container"]}>
        <fig className={classes["header-Main--profile-picture-fig"]}>
          ...
          />
          <figcaption
            className={classes["header-Main--profile-picture-caption"]}
          >
            Frank opone
          </figcaption>
        </fig>
        <p className={classes["header-Main--profile-parapagh"]}>
          web developer with a passion for creating innovative solutions. please
          feel free to reach out to me for any queries or collaborations. check
